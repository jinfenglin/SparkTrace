...
//TODO SDFGraph and SDFNode is reduludent. It can be simlified to use just SGraph. Internal nodes have no need to keep
//TODO outputType, only the graph or TraceTask need to keep this information.
